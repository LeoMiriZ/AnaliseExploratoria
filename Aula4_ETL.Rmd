...
Essa tabela foi raspada do site do Impostômetro e mostra o percentual de taxação desses produtos.
...
#write.xlsx(prices, "preço.xlsx", row.names = FALSE)

knitr::kable(prices)

```

Outra forma de trabalhar os dados raspado é levá-los para uma planilha do Excel e trabalhar com eles lá no Excel

```{r}

preco = read_excel("preco.xlsx")

ggplot(preco, aes(y=prices))+geom_boxplot(fill = "Aquamarine")
